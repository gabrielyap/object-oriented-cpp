...
class AbstractStubServer : public jsonrpc::AbstractServer<AbstractStubServer>
{
    public:
        AbstractStubServer(jsonrpc::AbstractServerConnector &conn, jsonrpc::serverVersion_t type = jsonrpc::JSONRPC_SERVER_V2) : jsonrpc::AbstractServer<AbstractStubServer>(conn, type)
        {
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("calculate", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_ARRAY, "args",jsonrpc::JSON_OBJECT, NULL), &AbstractStubServer::calculateI);
        ...
        inline virtual void calculateI(const Json::Value &request, Json::Value &response)
        {
            response = this->calculate(request["args"]);
        }
        ...
        virtual Json::Value calculate(const Json::Value& args) = 0;
