...
public:
  ...
  virtual Json::Value Conflict_of_Interest(const std::string& action, const std::string& arguments,
				 const std::string& class_id, const std::string& host_url,
				 const std::string& object_id, const std::string& owner_vsID);
  virtual Json::Value OperatorEqEq(const std::string& aPerson_classid, const std::string& aPerson_host_url, 
        const std::string& aPerson_object_id, const std::string& aPerson_owner_vsID, const std::string& action,
...
(const std::string& aPerson_classid, const std::string& aPerson_host_url, 
        const std::string& aPerson_object_id, const std::string& aPerson_owner_vsID, const std::string& action,
        const std::string& arguments,
			 const std::string& class_id, const std::string& host_url,
				 const std::string& object_id, const std::string& owner_vsID)
{
  ...
  if ((class_id != "Person") || ((object_id != "00000005") && (object_id != "00000006")) || 
        ((aPerson_object_id != "00000005") && (aPerson_object_id != "00000006")))
    {
      strJson += "{\"status\" : \"failed\", ";
      if (class_id != "Flight")
	strJson += ("\"reason\": \"class " + class_id + " unknown\"}");
    ...
    {
      if ((object_id == "00000005") && (aPerson_object_id == "000000006"))
        res = ((*p1_ptr) == (*p2_ptr));
      if ((object_id == "00000005") && (aPerson_object_id == "000000005"))
        res = ((*p1_ptr) == (*p1_ptr));
      if ((object_id == "00000006") && (aPerson_object_id == "000000005"))
        res = ((*p1_ptr) == (*p2_ptr));
      if ((object_id == "00000006") && (aPerson_object_id == "000000006"))
        res = ((*p1_ptr) == (*p2_ptr));
				 ...
				 const std::string& object_id, const std::string& owner_vsID)
{
  ...
  if ((class_id != "Person") || ((object_id != "00000005") && (object_id != "00000006")))
    ...
    {
      if (object_id == "00000005") res = p1_ptr->getVsID();
      if (object_id == "00000006") res = p2_ptr->getVsID();
...
int main() {
  ...
  Person p1 {"http://169.237.6.102", "1234567890", "Person", "0000000005", 
              "Lion King", "123456789123456789"};
  //Person p2 {"Lion Queen", "223456789123456789"};
  Shadow_Person sp2 {"http://169.237.6.102", "1234567890", "Person", "000000006"};

  Flight f1 {"http://169.237.6.102", "1234567890", "Flight", "00000001",
      TR_TYPE_FLIGHT, "desc", (Person&) sp2, gps_Davis, IP_Davis, time(NULL), p1, United, 
      "1234567890", gps_Sydney, gps_Davis};

  Flight f2 {"http://169.237.6.102", "1234567890", "Flight", "00000002",
      TR_TYPE_FLIGHT, "desc", p1, gps_Davis, IP_Davis, time(NULL),
      (Person&) sp2, United, "1234567890", gps_Davis, gps_NYC};
