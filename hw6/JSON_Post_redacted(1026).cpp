...
Comment * comment_ptr;
  ...
  if ((myv["comments"]["count"]).asInt() > 0)
  {
    ...
    for (i = 0; i < (myv["comments"]["count"]).asInt(); i++)
      ...
      //std::cout<<"SPACE"<<std::endl; //Will print, error below
      ...
      {
        //std::cout<<"SPACE"<<std::endl; //error comes here
      ...
      {
        std::cout<<"SPACE 1"<<std::endl; //will print
        
        comment_ptr->tags = NULL;
        std::cout<<"SPACE 2"<<std::endl; //not print
      }
          
          
          
          //std::cout<<"SPACE"<<std::endl;//won't print
...
(std::string key)
{
  std::cout<<"SPACE 12"<<std::endl;//prints in server
